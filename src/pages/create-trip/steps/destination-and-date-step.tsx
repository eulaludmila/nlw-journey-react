...
export function DestinationAndDateStep({
  ...
  const displayedDate = eventStartAndDates && eventStartAndDates.from && eventStartAndDates.to ? `${format(eventStartAndDates.from, "d 'de' LLL")} até ${format(eventStartAndDates.to, "d 'de' LLL")}`: null
